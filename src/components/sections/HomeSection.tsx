            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                <div className="lg:col-span-7 space-y-6">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-xl leading-relaxed font-medium">
                        3+ years shipping production Android & iOS apps — BLoC, Clean Architecture,
                        Firebase, and Codemagic CI/CD. Expanding into full-stack with Python and FastAPI.
                        End-to-end ownership from architecture to App Store deployment.
                    </p>

                    {/* Stat pills */}
                    <div className="flex flex-wrap gap-3 pt-2">
                        <span className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs font-bold tracking-wide">
                            ~60% GPS Payload Reduced
                        </span>
                        <span className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs font-bold tracking-wide">
                            3hrs → 15min CI/CD
                        </span>
                        <span className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs font-bold tracking-wide">
                            50%+ Crash Rate Reduced
                        </span>
                        <span className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs font-bold tracking-wide">
                            4+ Apps Shipped
                        </span>
                        ...
                        <div className="relative w-full h-full overflow-hidden rounded-[2rem] border border-white/10">
                            ...
                            <div className="absolute bottom-8 left-8 right-8 bg-black/30 backdrop-blur-2xl border border-white/10 p-6 rounded-2xl flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white font-bold text-sm tracking-tight">Full-Stack Mobile · FastAPI · DSA</p>
                                </div>
                            </div>
                        </div>
                    </div>
